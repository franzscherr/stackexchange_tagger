...
class DBN(object):
    def __init__(self, layer_sizes, input_tensor, learning_rate=.001, hidden_tensor=None, n_fantasy_states=100):
        ...
        for i, size in enumerate(layer_sizes):
            rbm = RBM(current_input_size, size, current_input, learning_rate=learning_rate,
                      n_fantasy_states=n_fantasy_states, name='dbn_{}'.format(i))
